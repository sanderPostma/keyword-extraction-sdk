...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeywordExtraction.JobSettings();
  });
  ...
  describe('JobSettings', function() {
    it('should create an instance of JobSettings', function() {
      ...
      //var instane = new KeywordExtraction.JobSettings();
      //expect(instance).to.be.a(KeywordExtraction.JobSettings);
    });

    it('should have the property tfidfScheme (base name: "tfidfScheme")', function() {
      // uncomment below and update the code to test the property tfidfScheme
      //var instane = new KeywordExtraction.JobSettings();
    ...
    it('should have the property maxKeywords (base name: "maxKeywords")', function() {
      // uncomment below and update the code to test the property maxKeywords
      //var instane = new KeywordExtraction.JobSettings();
      //expect(instance).to.be();
    });
