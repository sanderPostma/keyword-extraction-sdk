...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KeywordExtraction.KeywordExtractionResponse();
  });
  ...
  describe('KeywordExtractionResponse', function() {
    it('should create an instance of KeywordExtractionResponse', function() {
      ...
      //var instane = new KeywordExtraction.KeywordExtractionResponse();
      //expect(instance).to.be.a(KeywordExtraction.KeywordExtractionResponse);
    });
    ...
    it('should have the property keywordList (base name: "keywordList")', function() {
      // uncomment below and update the code to test the property keywordList
      //var instane = new KeywordExtraction.KeywordExtractionResponse();
      //expect(instance).to.be();
    });
